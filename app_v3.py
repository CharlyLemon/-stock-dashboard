...
with st.spinner(f"Cargando datos para {ticker_raw}..."):
    ...
    ratios    = fmp_get("ratios-ttm", ticker_raw, {})
...
pe_ratio  = rat0.get("peRatioTTM") or rat0.get("priceEarningsRatio") or met0.get("peRatio")
pb_ratio  = rat0.get("priceToBookRatioTTM") or rat0.get("priceToBookRatio") or met0.get("pbRatio")
ps_ratio  = rat0.get("priceToSalesRatioTTM") or rat0.get("priceToSalesRatio") or met0.get("priceToSalesRatio")
ev_ebitda = rat0.get("enterpriseValueMultipleTTM") or met0.get("enterpriseValueOverEBITDA")
roe_raw   = rat0.get("returnOnEquityTTM") or rat0.get("returnOnEquity") or met0.get("returnOnEquity")
roa_raw   = rat0.get("returnOnAssetsTTM") or rat0.get("returnOnAssets") or met0.get("returnOnAssets")
roe       = roe_raw*100 if roe_raw else None
roa       = roa_raw*100 if roa_raw else None
fcf_yield = met0.get("freeCashFlowYieldTTM",0)*100 if met0.get("freeCashFlowYieldTTM") else (met0.get("freeCashFlowYield",0)*100 if met0.get("freeCashFlowYield") else None)
